...
import com.huawei.codelab.DrawAbility;
...
public class DrawAbilitySlice extends AbilitySlice {
    private static final String TAG = DrawAbilitySlice.class.getName();
    ...
    private Button back;
    private String[] as={"老虎","狮子","犀牛","狗","猫","鼠","狼","鸟","熊猫","熊","猴子","鹰","蛇","牛","猪","马","羊","鹿","鱼","鸡","鸭"};
    ...
    private void initView(Intent intent) {
        ...
        int x1= random.nextInt(as.length);
        int x2=random.nextInt(as.length);
        title.setText(isLocal ? "你要画->"+as[x1] : "你要画->"+as[x2]);
    ...
    private void findComponentById() {
        ...
        transform.setClickedListener(component -> {
            DeviceSelectDialog dialog = new DeviceSelectDialog(DrawAbilitySlice.this);
    ...
    private void startRemoteFas(List<String> deviceIds) {
        ...
        for (int i = 0; i < deviceIds.size(); i++) {
            ...
            Operation operation = new Intent.OperationBuilder()
                    ...
                    .withAbilityName(DrawAbility.class.getName())
